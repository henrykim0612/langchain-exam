...
vectorstore = PGVector(connection=connection, collection_name=collection_name, embeddings=embedding_model,
                       use_jsonb=True)
...
# 문서 생성
docs = [Document(page_content="there are cats in the pond", metadata={'id': 1, 'source': 'cats.txt'}),
...
index_1 = index(docs,
                ...
                source_id_key='source'  # 메타데이터의 source 를 아이디로 사용
                )
